...

{
	...
	printf("\n Diameter: %d", D);
	printf("\n");
	printf("\n Central vertex :");	// Если эксцентрисет равен радиусу
	for (int i = 0; i < N; i++) {
		if (eks[i] == R) {
			printf("%d ", i + 1);
		}
	...
	printf("\n");
	printf("\n Peripheral vertices :"); // Если эксцентрисет равен диаметру, то вершина переферийная
	for (int i = 0; i < N; i++) {
		if (eks[i] == D) {
			printf("%d ", i + 1);
		}
	...
	printf("\n");
	printf("\n Isolated:");	// Со степенью 0 изолированная 
	for (int i = 0; i < N; i++) {
		if (eks[i] == 0) {
			printf("%d ", i + 1);
		}
	...
	printf("\n");
	printf("\n Terminal:");	 // со степенью 1 концевая
	for (int i = 0; i < N; i++) {
		count = 0;
		for (int j = 0; j < N; j++) {
			if (Array[i][j] != 0) {
